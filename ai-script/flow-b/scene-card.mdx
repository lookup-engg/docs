...
<Frame>
  <img src="/images/ai-script/flow-b/scene-card/scene-1.png" alt="Scene card interface" />
</Frame>
The Generator VLO interface displaying a script divided into scene cards.
