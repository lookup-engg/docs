...
Admins have everything a Member has, plus the ability to invite members, change roles, create and manage libraries, configure the brand kit, and view workspace-level analytics. Admins cannot manage billing or delete the workspace.
